    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-black text-white py-12">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-6">
          <h3 className="text-lg font-semibold mb-6">Start a Challenge</h3>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-gray-900/50 border border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors text-white placeholder-gray-500"
              />
              <p className="mt-2 text-sm text-yellow-400">
                ⚠️ Problem title must match LeetCode exactly
              </p>
            </div>

            <div className="pt-4">
              <button className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 px-6 py-3 rounded-lg font-medium text-lg">
                Deal Me In
              </button>
              <p className="mt-3 text-center text-sm text-gray-400">
                Starting points: 0/21
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 grid grid-cols-2 gap-4">
          <div className="bg-gray-800/30 border border-gray-700 rounded-lg p-4">
            ...
            <p className="text-gray-400 text-sm">
              Confident with your current hand? Choose to stay for -3 points
            </p>
          </div>
          <div className="bg-gray-800/30 border border-gray-700 rounded-lg p-4">
            ...
            <p className="text-gray-400 text-sm">
              Max 21 points per problem. Go over, and you lose.
            </p>
          </div>
        </div>
      </div>
